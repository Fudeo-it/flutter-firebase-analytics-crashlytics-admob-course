...
import 'package:telegram_app/cubits/native_ad_cubit.dart';
...
class ChatPage extends ConnectivityWidget
        ...
        providers: [
          ...
          BlocProvider(
            create: (context) => ChatBloc(
              ...
              firebaseAnalytics: context.read(),
            )..findChat(
                user: user.uid,
                other: other.id!,
              ),
  ...
  Widget _messagesBody({required ChatState chatState}) =>
      BlocBuilder<DarkModeCubit, bool>(
        builder: (context, darkModeEnabled) => Expanded(
          child: Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage(darkModeEnabled
                    ? "assets/telegram_background_dark.jpg"
                    : "assets/telegram_background.jpg"),
                fit: BoxFit.cover,
              ),
            ),
  ...
  Widget _adItem(BuildContext context) => BlocBuilder<NativeAdCubit, NativeAd?>(
        builder: (context, nativeAd) => AnimatedContainer(
          height: nativeAd != null ? 60 : 0,
  ...
  Widget _noFriendsWidget(
    ...
    bool darkModeEnabled = false,
      ...
      Positioned(
        ...
        child: Container(
          decoration: BoxDecoration(
            color: darkModeEnabled ? Colors.blue : Colors.grey[300],
            borderRadius: BorderRadius.all(Radius.circular(16)),
            border: Border.all(
              color: darkModeEnabled ? Colors.blueAccent : Colors.grey[400]!,
            ),
          ),
          padding: const EdgeInsets.all(16),
          child: Text(
